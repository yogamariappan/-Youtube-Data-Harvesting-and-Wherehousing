...
with tab2:
    if st.button("migrate to SQL"):
        ...
        for index, row in channels_data.iterrows():
            query = "INSERT INTO youtube_project.Channel_details(channel_id,channel_name,subcription_count,channel_views,channel_description,playlist_id,video_count)values(%s,%s,%s,%s,%s,%s,%s)"
        ...
        for index, row in playlists_details.iterrows():
            query = "insert into youtube_project.playlist_details(playlist_id,channel_id,playlist_name)values(%s,%s,%s)"
        ...
        for index, row in videos_details.iterrows():
            query = "insert into youtube_project.video_details(video_id,playlist_ids,video_name,published_At,video_description,view_count,like_count,favorite_count,Thumnails,comment_count,caption_status,duration)values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
            mycursor.execute(query, (
        ...
        for index, row in comments_details.iterrows():
            query = "insert into youtube_project.comment_details(comment_id,comment_text,comment_author,comment_publishedAt)values(%s,%s,%s,%s)"
